...
/**
 * This function will return true if 2 triangles intersect, false otherwise.
 */
bool ray_intersects_triangle( const Eigen::Matrix3d &ray_origin, // THIS IS FROM WIKIPEDIA, AS A TEMPLATE. MODIFY THIS
