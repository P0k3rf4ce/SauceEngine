...
namespace sauce {
    ...
    IBLGenerator::IBLGenerator(const sauce::PhysicalDevice& physicalDevice,
                               const sauce::LogicalDevice& logicalDevice)
        : physicalDevice(physicalDevice), logicalDevice(logicalDevice) {
    }

    std::unique_ptr<IBLMaps> IBLGenerator::generateIBLMaps(const std::string& hdrPath,
        ...
        sauce::BufferUtils::createBuffer(
            physicalDevice, logicalDevice, imageSize, vk::BufferUsageFlagBits::eTransferSrc,
        ...
        sauce::ImageUtils::createImage(
            physicalDevice, logicalDevice, width, height, vk::Format::eR32G32B32A32Sfloat,
            vk::ImageTiling::eOptimal,
            vk::ImageUsageFlagBits::eTransferDst | vk::ImageUsageFlagBits::eSampled,
            vk::MemoryPropertyFlagBits::eDeviceLocal, hdrImage, hdrImageMemory);

        sauce::ImageUtils::transitionImageLayout(
            logicalDevice, commandPool, queue, hdrImage, vk::ImageLayout::eUndefined,
        ...
        sauce::ImageUtils::copyBufferToImage(logicalDevice, commandPool, queue, stagingBuffer,
                                             hdrImage, width, height);
        sauce::ImageUtils::transitionImageLayout(
            logicalDevice, commandPool, queue, hdrImage, vk::ImageLayout::eTransferDstOptimal,
        ...
        vk::raii::ImageView hdrView = sauce::ImageUtils::createImageView(
            logicalDevice, hdrImage, vk::Format::eR32G32B32A32Sfloat,
    ...
    void IBLGenerator::createCubeMesh(const vk::raii::CommandPool& commandPool,
                                      const vk::raii::Queue& queue) {
        ...
        sauce::BufferUtils::createBuffer(
            physicalDevice, logicalDevice, vertexBufferSize,
            vk::BufferUsageFlagBits::eTransferDst | vk::BufferUsageFlagBits::eVertexBuffer,
            vk::MemoryPropertyFlagBits::eDeviceLocal, vertexBuffer, vertexBufferMemory);
        sauce::BufferUtils::copyBuffer(logicalDevice, commandPool, queue, vertexStagingBuffer,
        ...
        sauce::BufferUtils::createBuffer(
            physicalDevice, logicalDevice, indexBufferSize,
            vk::BufferUsageFlagBits::eTransferDst | vk::BufferUsageFlagBits::eIndexBuffer,
            vk::MemoryPropertyFlagBits::eDeviceLocal, indexBuffer, indexBufferMemory);
        sauce::BufferUtils::copyBuffer(logicalDevice, commandPool, queue, indexStagingBuffer,
    ...
    vk::raii::ShaderModule IBLGenerator::createShaderModule(const std::string& filename) {
        ...
        file.close();
        vk::ShaderModuleCreateInfo createInfo{.codeSize = buffer.size() * sizeof(uint32_t),
                                              .pCode = buffer.data()};
        return vk::raii::ShaderModule(*logicalDevice, createInfo);
    }

    void IBLGenerator::convertEquirectangularToCubemap(const vk::raii::ImageView& hdrView,
                                                       IBLMaps& maps,
                                                       const vk::raii::CommandPool& commandPool,
                                                       const vk::raii::Queue& queue) {
        ...
        sauce::ImageUtils::createImage(
            physicalDevice, logicalDevice, resolution, resolution, format,
            vk::ImageTiling::eOptimal,
            vk::ImageUsageFlagBits::eColorAttachment | vk::ImageUsageFlagBits::eSampled |
                vk::ImageUsageFlagBits::eTransferSrc | vk::ImageUsageFlagBits::eTransferDst,
            vk::MemoryPropertyFlagBits::eDeviceLocal, maps.envCubemap, maps.envCubemapMemory, 1, 6,
            vk::ImageCreateFlagBits::eCubeCompatible);
        maps.envCubemapView = sauce::ImageUtils::createImageView(
            logicalDevice, maps.envCubemap, format, vk::ImageAspectFlagBits::eColor,
            vk::ImageViewType::eCube, 1, 6);
        ...
        sauce::ImageUtils::transitionImageLayout(
            logicalDevice, commandPool, queue, maps.envCubemap, vk::ImageLayout::eUndefined,
            vk::ImageLayout::eShaderReadOnlyOptimal, {}, vk::AccessFlagBits2::eShaderRead,
            vk::PipelineStageFlagBits2::eNone, vk::PipelineStageFlagBits2::eFragmentShader, 1, 6);
    }

    void IBLGenerator::generateIrradianceMap(IBLMaps& maps,
                                             const vk::raii::CommandPool& commandPool,
                                             const vk::raii::Queue& queue) {
        ...
        sauce::ImageUtils::createImage(
            ...
            vk::ImageTiling::eOptimal,
            vk::ImageUsageFlagBits::eColorAttachment | vk::ImageUsageFlagBits::eSampled,
            vk::MemoryPropertyFlagBits::eDeviceLocal, maps.irradianceMap, maps.irradianceMapMemory,
            1, 6, vk::ImageCreateFlagBits::eCubeCompatible);
        maps.irradianceMapView = sauce::ImageUtils::createImageView(
            logicalDevice, maps.irradianceMap, format, vk::ImageAspectFlagBits::eColor,
            vk::ImageViewType::eCube, 1, 6);

        sauce::ImageUtils::transitionImageLayout(
            logicalDevice, commandPool, queue, maps.irradianceMap, vk::ImageLayout::eUndefined,
            vk::ImageLayout::eShaderReadOnlyOptimal, {}, vk::AccessFlagBits2::eShaderRead,
            vk::PipelineStageFlagBits2::eNone, vk::PipelineStageFlagBits2::eFragmentShader, 1, 6);
    }

    void IBLGenerator::generatePrefilterMap(IBLMaps& maps, const vk::raii::CommandPool& commandPool,
                                            const vk::raii::Queue& queue) {
        ...
        sauce::ImageUtils::createImage(
            ...
            vk::ImageTiling::eOptimal,
            vk::ImageUsageFlagBits::eColorAttachment | vk::ImageUsageFlagBits::eSampled,
            vk::MemoryPropertyFlagBits::eDeviceLocal, maps.prefilterMap, maps.prefilterMapMemory,
            mipLevels, 6, vk::ImageCreateFlagBits::eCubeCompatible);
        maps.prefilterMapView = sauce::ImageUtils::createImageView(
            logicalDevice, maps.prefilterMap, format, vk::ImageAspectFlagBits::eColor,
            vk::ImageViewType::eCube, mipLevels, 6);
        ...
        sauce::ImageUtils::transitionImageLayout(
            logicalDevice, commandPool, queue, maps.prefilterMap, vk::ImageLayout::eUndefined,
            vk::ImageLayout::eShaderReadOnlyOptimal, {}, vk::AccessFlagBits2::eShaderRead,
            vk::PipelineStageFlagBits2::eNone, vk::PipelineStageFlagBits2::eFragmentShader,
            mipLevels, 6);
    }

    void IBLGenerator::generateBRDFLUT(IBLMaps& maps, const vk::raii::CommandPool& commandPool,
                                       const vk::raii::Queue& queue) {
        uint32_t resolution = 512;
        ...
        sauce::ImageUtils::createImage(
            ...
            vk::ImageTiling::eOptimal,
            vk::ImageUsageFlagBits::eColorAttachment | vk::ImageUsageFlagBits::eSampled,
            vk::MemoryPropertyFlagBits::eDeviceLocal, maps.brdfLUT, maps.brdfLUTMemory);
        maps.brdfLUTView = sauce::ImageUtils::createImageView(logicalDevice, maps.brdfLUT, format,
                                                              vk::ImageAspectFlagBits::eColor);

        sauce::ImageUtils::transitionImageLayout(
            logicalDevice, commandPool, queue, maps.brdfLUT, vk::ImageLayout::eUndefined,
            vk::ImageLayout::eShaderReadOnlyOptimal, {}, vk::AccessFlagBits2::eShaderRead,
            vk::PipelineStageFlagBits2::eNone, vk::PipelineStageFlagBits2::eFragmentShader);
    }
