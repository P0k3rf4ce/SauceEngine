...
namespace sauce {
    namespace modeling {
        ...
        void Mesh::initVulkanResources(const sauce::LogicalDevice& logicalDevice,
            ...
            sauce::BufferUtils::copyBuffer(logicalDevice, commandPool, queue, stagingVertexBuffer,
            ...
            sauce::BufferUtils::copyBuffer(logicalDevice, commandPool, queue, stagingIndexBuffer,
