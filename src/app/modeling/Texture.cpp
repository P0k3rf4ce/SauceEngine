...
namespace sauce {
    namespace modeling {
        ...
        void Texture::initVulkanResources(const sauce::LogicalDevice& logicalDevice,
            ...
            sauce::BufferUtils::createBuffer(physicalDevice, logicalDevice, imageSize,
            ...
            sauce::ImageUtils::createImage(
                physicalDevice, logicalDevice, width, height, imageFormat,
                vk::ImageTiling::eOptimal,
                vk::ImageUsageFlagBits::eTransferDst | vk::ImageUsageFlagBits::eSampled,
                vk::MemoryPropertyFlagBits::eDeviceLocal, *image, *imageMemory);

            sauce::ImageUtils::transitionImageLayout(
                logicalDevice, commandPool, queue, *image, vk::ImageLayout::eUndefined,
            ...
            sauce::ImageUtils::transitionImageLayout(
                logicalDevice, commandPool, queue, *image, vk::ImageLayout::eTransferDstOptimal,
            ...
            imageView = std::make_unique<vk::raii::ImageView>(sauce::ImageUtils::createImageView(
                logicalDevice, *image, imageFormat, vk::ImageAspectFlagBits::eColor));

            bool isEnvMap = (type == TextureType::EnvironmentMapHDR);
            vk::SamplerAddressMode addressMode =
                isEnvMap ? vk::SamplerAddressMode::eClampToEdge : vk::SamplerAddressMode::eRepeat;
            ...
            samplerInfo.borderColor =
                hdr ? vk::BorderColor::eFloatOpaqueBlack : vk::BorderColor::eIntOpaqueBlack;
        ...
        vk::DescriptorImageInfo Texture::getDescriptorInfo() const {
            if (!hasGPUData()) {
                throw std::runtime_error("GPU resources not initialized for " + path);
            }
