...
namespace sauce {
    ...
    struct GraphicsPipeline {
        ...
        GraphicsPipeline(const sauce::GraphicsPipelineConfig& config) : config(config) {
            vk::raii::ShaderModule shaderModule =
                createShaderModule(config.logicalDevice, readBinaryFile(config.shaderPath));
        ...
        GraphicsPipeline(const sauce::GraphicsPipelineConfig& config,
                         const std::string& vertShaderPath, const std::string& fragShaderPath)
            : config(config) {
            vertShaderModule =
                createShaderModule(config.logicalDevice, readBinaryFile(vertShaderPath));
            fragShaderModule =
                createShaderModule(config.logicalDevice, readBinaryFile(fragShaderPath));
        ...
        GraphicsPipeline(const sauce::PhysicalDevice& physicalDevice,
                         const sauce::LogicalDevice& logicalDevice,
                         const std::vector<vk::DescriptorSetLayout>& descriptorSetLayouts,
                         vk::Format colorFormat, const std::string& vertShaderPath,
                         const std::string& fragShaderPath, const GraphicsPipelineConfig& config)
            : config(config) {
            ...
            initPipelineConfigurable(physicalDevice, logicalDevice, descriptorSetLayouts,
                                     colorFormat, shaderStages, config);
        }
      ...
      private:
        ...
        void initPipeline(vk::PipelineShaderStageCreateInfo* shaderStages) {
            ...
            vk::PipelineVertexInputStateCreateInfo vertexInputInfo{
                ...
                .vertexAttributeDescriptionCount =
                    config.hasVertexInput ? static_cast<uint32_t>(attributeDescriptions.size())
                                          : 0u,
                .pVertexAttributeDescriptions =
                    config.hasVertexInput ? attributeDescriptions.data() : nullptr,
            };
            ...
            vk::PipelineRenderingCreateInfo renderingCreateInfo{
                ...
                .depthAttachmentFormat =
                    config.depthTestEnable ? depthFormat : vk::Format::eUndefined,
            };
        ...
        void initPipelineConfigurable(
            const sauce::PhysicalDevice& physicalDevice, const sauce::LogicalDevice& logicalDevice,
            const std::vector<vk::DescriptorSetLayout>& descriptorSetLayouts,
            vk::Format colorFormat, vk::PipelineShaderStageCreateInfo* shaderStages,
            ...
            vk::PipelineRasterizationStateCreateInfo rasterizerInfo{
                ...
                .rasterizerDiscardEnable = vk::False,
                .polygonMode = vk::PolygonMode::eFill,
                .cullMode = config.enableCulling ? vk::CullModeFlagBits::eBack
      ...
      private:
        ...
        [[nodiscard]] vk::raii::ShaderModule createShaderModule(
            const sauce::LogicalDevice& logicalDevice, const std::vector<char>& code) const {
        ...
        static vk::Format findSupportedFormat(const sauce::PhysicalDevice& physicalDevice,
