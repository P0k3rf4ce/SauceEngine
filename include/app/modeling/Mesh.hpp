    ...
    namespace modeling {
        ...
        class Mesh {
          public:
            ...
            const std::vector<sauce::Vertex>& getVertices() const {
                return vertices;
            }
            ...
            void initVulkanResources(vk::raii::Device& device,
          ...
          private:
            ...
            uint32_t findMemoryType(vk::PhysicalDeviceMemoryProperties memProperties,
