...
namespace sauce {
    ...
    class IBLGenerator {
      public:
        IBLGenerator(const sauce::PhysicalDevice& physicalDevice,
                     const sauce::LogicalDevice& logicalDevice);

        std::unique_ptr<IBLMaps> generateIBLMaps(const std::string& hdrPath,
      ...
      private:
        ...
        void convertEquirectangularToCubemap(const vk::raii::ImageView& hdrView, IBLMaps& maps,
                                             const vk::raii::CommandPool& commandPool,
                                             const vk::raii::Queue& queue);

        void generateIrradianceMap(IBLMaps& maps, const vk::raii::CommandPool& commandPool,
                                   const vk::raii::Queue& queue);

        void generatePrefilterMap(IBLMaps& maps, const vk::raii::CommandPool& commandPool,
                                  const vk::raii::Queue& queue);

        void generateBRDFLUT(IBLMaps& maps, const vk::raii::CommandPool& commandPool,
                             const vk::raii::Queue& queue);
