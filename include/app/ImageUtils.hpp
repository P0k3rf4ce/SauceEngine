...
namespace sauce {
    ...
    struct ImageUtils {
        static void createImage(const sauce::PhysicalDevice& physicalDevice,
                                const sauce::LogicalDevice& logicalDevice, uint32_t width,
        ...
        static vk::raii::ImageView createImageView(
            const sauce::LogicalDevice& logicalDevice, vk::raii::Image& image, vk::Format format,
            vk::ImageAspectFlags aspectFlags, vk::ImageViewType viewType = vk::ImageViewType::e2D,
            uint32_t mipLevels = 1, uint32_t arrayLayers = 1, uint32_t baseMipLevel = 0,
            uint32_t baseArrayLayer = 0) {
            vk::ImageViewCreateInfo viewInfo{.image = image,
                                             .viewType = viewType,
                                             .format = format,
                                             .subresourceRange = {aspectFlags, baseMipLevel,
                                                                  mipLevels, baseArrayLayer,
                                                                  arrayLayers}};
        ...
        static void copyBufferToImage(const sauce::LogicalDevice& logicalDevice,
                                      const vk::raii::CommandPool& commandPool,
                                      const vk::raii::Queue& queue,
                                      const vk::raii::Buffer& srcBuffer, vk::raii::Image& dstImage,
            ...
            copyCommandBuffer.copyBufferToImage(srcBuffer, dstImage,
        ...
        static void transitionImageLayout(
            const sauce::LogicalDevice& logicalDevice, const vk::raii::CommandPool& commandPool,
            const vk::raii::Queue& queue, vk::raii::Image& image, vk::ImageLayout oldLayout,
            vk::ImageLayout newLayout, vk::AccessFlags2 srcAccessMask,
            vk::AccessFlags2 dstAccessMask, vk::PipelineStageFlags2 srcStageMask,
            vk::PipelineStageFlags2 dstStageMask, uint32_t mipLevels = 1, uint32_t arrayLayers = 1,
            ...
            vk::raii::CommandBuffer transitionCommandBuffer = std::move(
                logicalDevice->allocateCommandBuffers(transitionCommandBufferAllocInfo).front());
