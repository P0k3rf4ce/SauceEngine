...
namespace sauce::editor {
    ...
    class EditorApp {
      public:
        ...
        sauce::Scene& getScene() {
            return *pScene;
        }
        const sauce::Scene& getScene() const {
            return *pScene;
        }
        ...
        const sauce::PhysicalDevice& getPhysicalDevice() const {
            return physicalDevice;
        }
        const sauce::LogicalDevice& getLogicalDevice() const {
            return logicalDevice;
        }
        sauce::Renderer& getRenderer() {
            return *pRenderer;
        }
